            ...
            if pos['has_position']:
                ...
                if side == 'long':
                    if current <= entry * 0.985:
                        ...
                        await trading_bot.send_telegram_message(f"🔴 *STOP LOSS HIT*\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\nSide: LONG\nEntry: ${entry:.2f}\nClose: ${current:.2f}\nPnL: {pnl:+.2f} USDT")
                    elif current >= entry * 1.03:
                        logger.info(f"🎯 TAKE PROFIT HIT! Closing LONG at ${current:.2f}")
                        kucoin.close_position()
                        # Kirim notifikasi Telegram
                        await trading_bot.send_telegram_message(f"🎯 *TAKE PROFIT HIT*\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\nSide: LONG\nEntry: ${entry:.2f}\nClose: ${current:.2f}\nPnL: {pnl:+.2f} USDT")
                else:
